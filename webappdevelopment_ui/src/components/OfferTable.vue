    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'finalOffer',
          visible: true,
          scopedSlots: { customRender: 'finalOffer' },
          sorter: true
          //sorter: (a, b) => a.finalOffer - b.finalOffer,
          //sorter: (a, b) => a.finalOffer.localeCompare(b.finalOffer),
        },
        {
          title: 'Offer Date',
		dataIndex: 'offerDate',
          ...
          sorter: true
          //sorter: (a, b) => a.offerDate - b.offerDate,
          //sorter: (a, b) => a.offerDate.localeCompare(b.offerDate),
        },
      ],
      pagination: {
        current: 1,
