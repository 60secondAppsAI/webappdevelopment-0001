...
<template>
  ...
  <base-input label="SecurityFeatures" type="text" placeholder="Enter SecurityFeatures" v-model="storageToAdd.securityFeatures"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'securityFeatures',
          visible: true,
          scopedSlots: { customRender: 'securityFeatures' },
          sorter: true
          //sorter: (a, b) => a.securityFeatures - b.securityFeatures,
          //sorter: (a, b) => a.securityFeatures.localeCompare(b.securityFeatures),
        },
      ],
      pagination: {
        current: 1,
