              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Deal Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Deal Status</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="DealStatus" type="text" placeholder="Enter DealStatus" v-model="dealDetails.dealStatus"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Deal Info</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="DealInfo" type="text" placeholder="Enter DealInfo" v-model="dealDetails.dealInfo"></input>
																		</div>
						</td>
														</tr>
