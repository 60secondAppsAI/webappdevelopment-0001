              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Repayment Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Repayment Schedule</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="RepaymentSchedule" type="text" placeholder="Enter RepaymentSchedule" v-model="repaymentDetails.repaymentSchedule"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Remaining Balance</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="RemainingBalance" type="text" placeholder="Enter RemainingBalance" v-model="repaymentDetails.remainingBalance"></input>
																		</div>
						</td>
														</tr>
