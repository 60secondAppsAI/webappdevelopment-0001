              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Agreement Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Document Link</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="DocumentLink" type="text" placeholder="Enter DocumentLink" v-model="agreementDetails.documentLink"></input>
																		</div>
						</td>
														</tr>
															<tr> 
