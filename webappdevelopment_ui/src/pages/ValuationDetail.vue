              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Valuation Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Final Offer Range</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="FinalOfferRange" type="text" placeholder="Enter FinalOfferRange" v-model="valuationDetails.finalOfferRange"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Valuation Date</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<datepicker v-model="valuationDetails.valuationDate"  placeholder="Select Date" ></datepicker>
																		</div>
						</td>
														</tr>
